<template>
  <div>
    <el-input
      placeholder="请输入答案,回车即可添加对应填空内容"
      v-model="answerContent"
      @change="getContent"
      class="answer-input"
    ></el-input>
    <!-- <content-list :answerList="answerList" :serialType="'number'" answerType="'completion'" @delContent="delContent" @editContent='editContent'></content-list> -->
